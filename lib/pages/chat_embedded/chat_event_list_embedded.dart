...
import 'package:fluffychat/pages/chat_embedded/seen_by_row_embedded.dart';
import 'package:fluffychat/pages/chat_embedded/typing_indicators_embedded.dart';
...
class ChatEmbeddedEventList extends StatelessWidget {
  final ChatEmbeddedController controller;

  const ChatEmbeddedEventList({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    final hasWallpaper = controller.room.client.applicationAccountConfig.wallpaperUrl != null;
          ...
          (BuildContext context, int i) {
            ...
            if (i == 0) {
              ...
              return Column(
                ...
                children: [
                  SeenByRowEmbedded(controller),
                  TypingIndicatorsEmbedded(controller),
                ],
              );
            }
            ...
            if (i == events.length + 1) {
              ...
              if (timeline.canRequestHistory) {
                return Builder(
                  builder: (context) {
                    WidgetsBinding.instance.addPostFrameCallback(controller.requestHistory);
                    return Center(
                      child: IconButton(
            ...
            return AutoScrollTag(
              ...
              child: Message(
                ...
                singleSelected: controller.selectedEvents.singleOrNull?.eventId == event.eventId,
                onEdit: () => controller.editSelectedEventAction(),
                timeline: timeline,
                displayReadMarker: i > 0 && controller.readMarkerEventId == event.eventId,
                nextEvent: nextEvent,
